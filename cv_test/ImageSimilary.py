...
def runAllImageSimilaryFun(para1, para2):
    ...
    if para1.startswith("http"):
        ...
        return "%.2f %.2f %.2f %.2f %.2f" % (1 - float(n1 / 64), 1 - float(n2 / 64), 1 - float(n3 / 64), round(n4[0], 2), n5[0])
        # except:
        #     pass
...
if __name__ == "__main__":
    ...
    p1 = r'D:\UGit\testset\facedetect_badcase\noface\468092093890298547_1604783509791.jpg'
    p2 = r'D:\UGit\testset\facedetect_badcase\noface\468092127352455859_1604783514721.jpg'
